...
const form = createEl('form', ['regForm', 'needs-validation'], {'novalidate': ''});
    registrPanel.appendChild(form);
        ...
        //email label with Email
            const emailLabel = createEl('label', ['col-sm-2', 'col-form-label'],{"for": "inputEmail3"})
        ...
        form.appendChild(divRow3);
            ...
            const nickLabel = createEl('label', ['col-sm-2', 'col-form-label'], {'for': 'inputNick3'});     
        ...
        form.appendChild(divRow2);
            ...
            const passwordLabel = createEl('label', ['col-sm-2', 'col-form-label'],{'for': 'inputPassword3'});
        ...
        form.appendChild(divRow4);
            ...
            const inputRepeatPassword2 = createEl('input', ['form-control','password-control2'], {
                'id': 'inputPassword4',
                'name': 'inputPass',
                'type': 'password',
                'placeholder': 'Hasło',
        ...
        form.appendChild(footer);
            ...
            //submit action
            const signInButton = NavButton('Sign in',Login,['btn','btn-secondary','btn-sm']);
        ...
        submitInButton.addEventListener('click', (e) =>{
            ...
            e.preventDefault();
            registrationAttempt(inputEmail.value, inputNickname.value, inputPassword.value, inputRepeatPassword2.value);      
